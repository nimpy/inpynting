from data_structures import Node, Image2BInpainted, coordinates_to_position, UP, DOWN, LEFT, RIGHT, get_half_patch_from_patch
...
def testing_prune_labels():
    patch = Node(0, False, False, 0, 0, 0, [1, 2, 3, 4, 5], None, {1: 7, 2: 9, 3: 6, 4: 8, 5: 10}, False) # 3 1 4 2 5
    patch.prune_labels(1)
    print(patch.pruned_labels)

def testing_get_neighbor_position():
    patch = Node(31, False, False, 12, 0)
